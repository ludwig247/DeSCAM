...
set DESIGN_REF_DATA_PATH          "/import/lab/users/mehmedag/DeSCAM_Remote/DeSCAM/doc/Howto/PowerEstimation/NangateOpenCellLibrary_PDKv1_3_v2010_12/"  ; ## <- Update (Library path)
