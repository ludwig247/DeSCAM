...
read_saif -auto_map_names -input /import/lab/users/mehmedag/DeSCAM_Remote/DeSCAM/example/RISCV_ISA/Dino_test/Saif_files2/addi.saif -instance_name cpu_tb/IF_CPU -verbose
