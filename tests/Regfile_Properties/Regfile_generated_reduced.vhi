...
-- DP SIGNALS --
macro out_sig : int_array := Regs_to_Control end macro;
...
prove:
	at t_end: start_state;
	at t: out_sig(0) = regs_0_at_t;
	at t: out_sig(10) = regs_10_at_t;
	at t: out_sig(11) = regs_11_at_t;
	at t: out_sig(12) = regs_12_at_t;
	at t: out_sig(13) = regs_13_at_t;
	at t: out_sig(14) = regs_14_at_t;
	at t: out_sig(15) = regs_15_at_t;
	at t: out_sig(16) = regs_16_at_t;
	at t: out_sig(17) = regs_17_at_t;
	at t: out_sig(18) = regs_18_at_t;
	at t: out_sig(19) = regs_19_at_t;
	at t: out_sig(1) = regs_1_at_t;
	at t: out_sig(20) = regs_20_at_t;
	at t: out_sig(21) = regs_21_at_t;
	at t: out_sig(22) = regs_22_at_t;
	at t: out_sig(23) = regs_23_at_t;
	at t: out_sig(24) = regs_24_at_t;
	at t: out_sig(25) = regs_25_at_t;
	at t: out_sig(26) = regs_26_at_t;
	at t: out_sig(27) = regs_27_at_t;
	at t: out_sig(28) = regs_28_at_t;
	at t: out_sig(29) = regs_29_at_t;
	at t: out_sig(2) = regs_2_at_t;
	at t: out_sig(30) = regs_30_at_t;
	at t: out_sig(31) = regs_31_at_t;
	at t: out_sig(3) = regs_3_at_t;
	at t: out_sig(4) = regs_4_at_t;
	at t: out_sig(5) = regs_5_at_t;
	at t: out_sig(6) = regs_6_at_t;
	at t: out_sig(7) = regs_7_at_t;
	at t: out_sig(8) = regs_8_at_t;
	at t: out_sig(9) = regs_9_at_t;
	at t_end: regs(0) = (((address_at_t = 0))?val_sig_at_t:regs_0_at_t);
	at t_end: regs(10) = (((address_at_t = 10))?val_sig_at_t:regs_10_at_t);
	at t_end: regs(11) = (((address_at_t = 11))?val_sig_at_t:regs_11_at_t);
	at t_end: regs(12) = (((address_at_t = 12))?val_sig_at_t:regs_12_at_t);
