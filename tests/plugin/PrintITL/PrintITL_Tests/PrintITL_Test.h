...
//        DISABLED_Examples,
        Examples,
        ITLTestExamples,
        testing::ValuesIn(parameter(SCAM_HOME"/tests/TestCases/tests.list")),
...
TEST_P(ITLTestExamples, Examples) {
    ...
    for (auto result: results) {
        ...
        std::ofstream myfile;
        myfile.open(SCAM_HOME"/tests/plugin/PrintITL/PrintITL_Tests/unsorted/" + module->getName() + ".vhi");
...
//    std::ifstream ifs(SCAM_HOME"/example/" + module->getName() +"/RTL/properties/" + module->getName() + ".vhi");
        std::ifstream ifs(SCAM_HOME"/tests/plugin/PrintITL/PrintITL_Tests/vhi/" + module->getName() + ".vhi");
        ASSERT_TRUE(bool(ifs)) << "Can't open file: " << SCAM_HOME"/tests/plugin/PrintITL/PrintITL_Tests/vhi/"
                               << module->getName() << ".vhi";
