...
//                header_includes[i].Name = line;
            ...
            header_includes[i].result.push_back(module.second);

            std::cout << "Number of modules: " << header_includes[i].result.size() << std::endl;
        i++;
...
public:
    ...
    struct PrintToStringParamName
    {
        ...
        {
            auto Parameter = static_cast<SCAM::Module *>(info.param);
