...
macro b_out_sig : int_2 := b_out end macro;
macro b_out_sig_0 : signed := b_out(0) end macro;
macro b_out_sig_1 : signed := b_out(1) end macro;
...
-- VISIBLE REGISTERS --
macro myArray : int_2 := myArray_signal end macro;
macro test : signed := test_signal end macro;
