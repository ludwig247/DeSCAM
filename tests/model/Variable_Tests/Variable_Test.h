...
protected:
    VariableTest():
            unsigned_var(DESCAM::Variable("unsigned_var",DataTypes::getDataType("unsigned"),new UnsignedValue(100))){
    }
    virtual void SetUp() {
    ...
    DESCAM::Variable unsigned_var;
};

TEST_F(VariableTest,createVar){
    ASSERT_NO_THROW(DESCAM::Variable("unsigned_var3",DataTypes::getDataType("unsigned"),new UnsignedValue(102)));
    ASSERT_NO_THROW(DESCAM::Variable("unsigned_var2",DataTypes::getDataType("unsigned"),new UnsignedValue(101)));
    ASSERT_NO_THROW(DESCAM::Variable("unsigned_var4",DataTypes::getDataType("unsigned")));
}
