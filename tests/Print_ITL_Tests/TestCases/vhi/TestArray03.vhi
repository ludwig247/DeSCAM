...
macro b_in_sig_0 : signed := end macro;
macro b_in_sig_1 : signed := end macro;
macro b_in_sig_2 : signed := end macro;
macro b_in_sig_3 : signed := end macro;
macro b_in_sig_4 : signed := end macro;
