...
macro out_master_2_sync : boolean := true end macro;
macro out_master_3_sync : boolean := true end macro;
...
macro val_master_2_sync : boolean := true end macro;
macro val_master_3_sync : boolean := true end macro;
...
macro out_master_2_notify : boolean := true end  macro;
macro out_master_3_notify : boolean := true end  macro;
...
macro val_master_2_notify : boolean := true end  macro;
macro val_master_3_notify : boolean := true end  macro;
...
--macro out_master_2_sig : bus_resp_t :={resize(0,32), resize(0,32)} end macro;
macro out_master_2_sig_hrdata : unsigned :=resize(0,32) end macro;
macro out_master_2_sig_hresp : unsigned :=resize(0,32) end macro;
--macro out_master_3_sig : bus_resp_t :={resize(0,32), resize(0,32)} end macro;
macro out_master_3_sig_hrdata : unsigned :=resize(0,32) end macro;
macro out_master_3_sig_hresp : unsigned :=resize(0,32) end macro;
...
--macro val_master_2_sig : bus_req_t :={resize(0,32), resize(0,32)} end macro;
macro val_master_2_sig_haddr : unsigned :=resize(0,32) end macro;
macro val_master_2_sig_hwdata : unsigned :=resize(0,32) end macro;
--macro val_master_3_sig : bus_req_t :={resize(0,32), resize(0,32)} end macro;
macro val_master_3_sig_haddr : unsigned :=resize(0,32) end macro;
macro val_master_3_sig_hwdata : unsigned :=resize(0,32) end macro;
