...
public:
    ...
    std::vector<std::vector<SCAM::Stmt*>> pathsAccessBus2;
    std::vector<std::vector<int>> pathsAccessBus2IDs;
    std::vector<std::vector<SCAM::Stmt*>> pathsAccessBus3;
    std::vector<std::vector<int>> pathsAccessBus3IDs;
    ...
    virtual void SetUp() {
        ...
        controlFlowMapAccessBus0.insert(std::make_pair(check_addr_slave1_master0->getId(),check_addr_slave1_master0));
        controlFlowMapAccessBus0.insert(std::make_pair(set_slave_id_1_master0->getId(),set_slave_id_1_master0));
        controlFlowMapAccessBus0.insert(std::make_pair(check_addr_slave2_master0->getId(),check_addr_slave2_master0));
        controlFlowMapAccessBus0.insert(std::make_pair(set_slave_id_2_master0->getId(),set_slave_id_2_master0));
        controlFlowMapAccessBus0.insert(std::make_pair(set_slave_id_3_master0->getId(),set_slave_id_3_master0));
        ...
        check_addr_slave2_master0->addSuccessor(set_slave_id_3_master0);
        ...
        controlFlowMapAccessBus1.insert(std::make_pair(check_addr_slave1_master1->getId(),check_addr_slave1_master1));
        controlFlowMapAccessBus1.insert(std::make_pair(set_slave_id_1_master1->getId(),set_slave_id_1_master1));
        controlFlowMapAccessBus1.insert(std::make_pair(check_addr_slave2_master1->getId(),check_addr_slave2_master1));
        controlFlowMapAccessBus1.insert(std::make_pair(set_slave_id_2_master1->getId(),set_slave_id_2_master1));
        controlFlowMapAccessBus1.insert(std::make_pair(set_slave_id_3_master1->getId(),set_slave_id_3_master1));
        ...
        check_addr_slave2_master1->addSuccessor(set_slave_id_3_master1);
        ...
        auto return_access_bus_master2 = new CfgNode(ret_access_bus);
        auto wait_master_read_master2 = new CfgNode(wait_master_read_notify);


        //Add Nodes to ControlFlowMap
        controlFlowMapAccessBus2.insert(std::make_pair(check_fromReset_master2->getId(),check_fromReset_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(wait_for_dummy_master2->getId(),wait_for_dummy_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(check_state_MASTER_REQ_master2->getId(),check_state_MASTER_REQ_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(wait_for_read_master2->getId(),wait_for_read_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(check_master_id_master2->getId(),check_master_id_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(set_master_id_master2->getId(),set_master_id_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(check_addr_slave0_master2->getId(),check_addr_slave0_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(set_slave_id_0_master2->getId(),set_slave_id_0_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(check_addr_slave1_master2->getId(),check_addr_slave1_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(set_slave_id_1_master2->getId(),set_slave_id_1_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(check_addr_slave2_master2->getId(),check_addr_slave2_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(set_slave_id_2_master2->getId(),set_slave_id_2_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(set_slave_id_3_master2->getId(),set_slave_id_3_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(set_req_hwdata_master2->getId(),set_req_hwdata_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(set_req_haddr_master2->getId(),set_req_haddr_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(notify_dummy_master2->getId(),notify_dummy_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(wait_dummy_master2->getId(),wait_dummy_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(check_master_id_neq_id_master2->getId(),check_master_id_neq_id_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(set_state_SLAVE_REQ_master2->getId(),set_state_SLAVE_REQ_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(notify_master_write_master2->getId(),notify_master_write_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(wait_slave_write_master2->getId(),wait_slave_write_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(set_out_hrdata_master2->getId(),set_out_hrdata_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(set_out_hresp_master2->getId(),set_out_hresp_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(set_state_MASTER_REQ_master2->getId(),set_state_MASTER_REQ_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(set_master_id_10_master2->getId(),set_master_id_10_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(set_slave_id_10_master2->getId(),set_slave_id_10_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(notify_master_read_master2->getId(),notify_master_read_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(return_access_bus_master2->getId(),return_access_bus_master2));
        controlFlowMapAccessBus2.insert(std::make_pair(wait_master_read_master2->getId(),wait_master_read_master2));
        ...
        check_addr_slave2_master2->addSuccessor(set_slave_id_3_master2);
        ...
        notify_master_write_master2->addSuccessor(wait_slave_write_master2);
        wait_slave_write_master2->addSuccessor(set_out_hrdata_master2);
        ...
        notify_master_read_master2->addSuccessor(return_access_bus_master2);
        wait_master_read_master2->addSuccessor(check_master_id_master2);

        //CFG Access Bus Master3
        ...
        auto return_access_bus_master3 = new CfgNode(ret_access_bus);
        auto wait_master_read_master3 = new CfgNode(wait_master_read_notify);


        //Add Nodes to ControlFlowMap
        controlFlowMapAccessBus3.insert(std::make_pair(check_fromReset_master3->getId(),check_fromReset_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(wait_for_dummy_master3->getId(),wait_for_dummy_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(check_state_MASTER_REQ_master3->getId(),check_state_MASTER_REQ_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(wait_for_read_master3->getId(),wait_for_read_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(check_master_id_master3->getId(),check_master_id_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(set_master_id_master3->getId(),set_master_id_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(check_addr_slave0_master3->getId(),check_addr_slave0_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(set_slave_id_0_master3->getId(),set_slave_id_0_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(check_addr_slave1_master3->getId(),check_addr_slave1_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(set_slave_id_1_master3->getId(),set_slave_id_1_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(check_addr_slave2_master3->getId(),check_addr_slave2_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(set_slave_id_2_master3->getId(),set_slave_id_2_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(set_slave_id_3_master3->getId(),set_slave_id_3_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(set_req_hwdata_master3->getId(),set_req_hwdata_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(set_req_haddr_master3->getId(),set_req_haddr_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(notify_dummy_master3->getId(),notify_dummy_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(wait_dummy_master3->getId(),wait_dummy_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(check_master_id_neq_id_master3->getId(),check_master_id_neq_id_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(set_state_SLAVE_REQ_master3->getId(),set_state_SLAVE_REQ_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(notify_master_write_master3->getId(),notify_master_write_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(wait_slave_write_master3->getId(),wait_slave_write_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(set_out_hrdata_master3->getId(),set_out_hrdata_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(set_out_hresp_master3->getId(),set_out_hresp_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(set_state_MASTER_REQ_master3->getId(),set_state_MASTER_REQ_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(set_master_id_10_master3->getId(),set_master_id_10_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(set_slave_id_10_master3->getId(),set_slave_id_10_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(notify_master_read_master3->getId(),notify_master_read_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(return_access_bus_master3->getId(),return_access_bus_master3));
        controlFlowMapAccessBus3.insert(std::make_pair(wait_master_read_master3->getId(),wait_master_read_master3));
        ...
        check_addr_slave2_master3->addSuccessor(set_slave_id_3_master3);
        ...
        notify_master_write_master3->addSuccessor(wait_slave_write_master3);
        wait_slave_write_master3->addSuccessor(set_out_hrdata_master3);
        ...
        notify_master_read_master3->addSuccessor(return_access_bus_master3);
        ...
        for(auto node: controlFlowMapAccessBus2){
            controlFlowMap.insert(std::make_pair(node.first,node.second));
        }
        for(auto node: controlFlowMapAccessBus3){
            controlFlowMap.insert(std::make_pair(node.first,node.second));
        }
        ...
        std::cout << printCFG(controlFlowMapAccessBus2) << std::endl;
        std::cout << printCFG(controlFlowMapAccessBus3) << std::endl;
        ...
        temp = {32,"master1_access_bus_sync"};
        startnodes.push_back(temp);
        temp = {61,"master2_access_bus_sync"};
        startnodes.push_back(temp);
        temp = {90,"master3_access_bus_sync"};
        startnodes.push_back(temp);
        temp = {119,"slave0_read_sync"};
        startnodes.push_back(temp);
        temp = {128,"slave1_read_sync"};
        startnodes.push_back(temp);
        temp = {137,"slave2_read_sync"};
        startnodes.push_back(temp);
        temp = {146,"slave3_read_sync"};
        startnodes.push_back(temp);
        temp = {155,"slave0_write_sync"};
        startnodes.push_back(temp);
        temp = {164,"slave1_write_sync"};
        startnodes.push_back(temp);
        temp = {173,"slave2_write_sync"};
        startnodes.push_back(temp);
        temp = {182,"slave3_write_sync"};
        startnodes.push_back(temp);

        temp = {30,"master0_access_bus_notify"};
        endnodes.push_back(temp);
        temp = {59,"master1_access_bus_notify"};
        endnodes.push_back(temp);
        temp = {88,"master2_access_bus_notify"};
        endnodes.push_back(temp);
        temp = {117,"master3_access_bus_notify"};
        endnodes.push_back(temp);
        temp = {126,"slave0_read_notify"};
        endnodes.push_back(temp);
        temp = {135,"slave1_read_notify"};
        endnodes.push_back(temp);
        temp = {144,"slave2_read_notify"};
        endnodes.push_back(temp);
        temp = {153,"slave3_read_notify"};
        endnodes.push_back(temp);
        temp = {162,"slave0_write_notify"};
        endnodes.push_back(temp);
        temp = {171,"slave1_write_notify"};
        endnodes.push_back(temp);
        temp = {180,"slave2_write_notify"};
        endnodes.push_back(temp);
        temp = {189,"slave3_write_notify"};
        endnodes.push_back(temp);

        //Define portnames for notify and sync signals
        portnames.push_back("val_master_0");
        portnames.push_back("val_master_1");
        portnames.push_back("val_master_2");
        portnames.push_back("val_master_3");
        portnames.push_back("out_slave_0");
        portnames.push_back("out_slave_1");
        portnames.push_back("out_slave_2");
        portnames.push_back("out_slave_3");
        portnames.push_back("val_slave_0");
        portnames.push_back("val_slave_1");
        portnames.push_back("val_slave_2");
        portnames.push_back("val_slave_3");
    }
...
TEST_F(OperationGraphTest, ExtractPaths){
    ...
    //Find important states AccessBus2
    std::map<int, CfgNode *> importantStatesAccessBus2;
    findImportantStates(controlFlowMapAccessBus2,&importantStatesAccessBus2);

    //Find paths AccessBus2
    auto start_AccessBus2 = controlFlowMapAccessBus2.begin()->second;
    findPathsfromNode(start_AccessBus2,&pathsAccessBus2,&pathsAccessBus2IDs);
    for(auto const& node : importantStatesAccessBus2) {
        findPathsfromNode(node.second,&pathsAccessBus2,&pathsAccessBus2IDs);
    }

    //Find important states AccessBus3
    std::map<int, CfgNode *> importantStatesAccessBus3;
    findImportantStates(controlFlowMapAccessBus3,&importantStatesAccessBus3);

    //Find paths AccessBus3
    auto start_AccessBus3 = controlFlowMapAccessBus3.begin()->second;
    findPathsfromNode(start_AccessBus3,&pathsAccessBus3,&pathsAccessBus3IDs);
    for(auto const& node : importantStatesAccessBus3) {
        findPathsfromNode(node.second,&pathsAccessBus3,&pathsAccessBus3IDs);
    }
    ...
    eventID AccessBus1 = {32,"AccessBus1"};
    eventID AccessBus2 = {61,"AccessBus2"};
    eventID AccessBus3 = {90,"AccessBus3"};
    eventID SlaveRead0 = {119,"SlaveRead0"};
    eventID SlaveRead1 = {128,"SlaveRead1"};
    eventID SlaveRead2 = {137,"SlaveRead2"};
    eventID SlaveRead3 = {146,"SlaveRead3"};
    eventID SlaveWrite0 = {155,"SlaveWrite0"};
    eventID SlaveWrite1 = {164,"SlaveWrite1"};
    eventID SlaveWrite2 = {173,"SlaveWrite2"};
    eventID SlaveWrite3 = {182,"SlaveWrite3"};
    eventID dummy = {191,"dummy"};
    ...
    functions.push_back(AccessBus2);
    functions.push_back(AccessBus3);
    ...
    for(int i=0; i<pathsAccessBus2IDs.size();i++){
        pathIDStmt p = {pathsAccessBus2IDs.at(i),pathsAccessBus2.at(i)};
        allPaths.push_back(p);
    }
    for(int i=0; i<pathsAccessBus3IDs.size();i++){
        pathIDStmt p = {pathsAccessBus3IDs.at(i),pathsAccessBus3.at(i)};
        allPaths.push_back(p);
    }
    ...
    std::ofstream myfile;
    myfile.open(SCAM_HOME"/tests/Bus4_Properties/" + module->getName() + "_generated.vhi");
