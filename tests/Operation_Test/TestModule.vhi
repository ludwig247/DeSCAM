...
prove:
	...
	at t_end: tail = ((tail_at_t + 1)(31 downto 0) mod signed(fifo_size_at_t))(31 downto 0);
	at t_end: val_sig = val_sig_at_t;
...
prove:
	...
	at t_end: fifo_size = fifo_size_at_t;
	at t_end: head = ((head_at_t + 1)(31 downto 0) mod signed(fifo_size_at_t))(31 downto 0);
	at t_end: out_sig = out_sig_at_t;
	at t_end: state = FULL;
	at t_end: tail = tail_at_t;
	at t_end: val_sig = val_sig_at_t;
