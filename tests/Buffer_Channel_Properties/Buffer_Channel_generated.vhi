...
-- VISIBLE REGISTERS --
macro buffer0 : int_8 :={resize(0,32), resize(0,32), resize(0,32), resize(0,32), resize(0,32), resize(0,32), resize(0,32), resize(0,32)} end macro;
macro buffer1 : int_8 :={resize(0,32), resize(0,32), resize(0,32), resize(0,32), resize(0,32), resize(0,32), resize(0,32), resize(0,32)} end macro;
macro buffer2 : int_8 :={resize(0,32), resize(0,32), resize(0,32), resize(0,32), resize(0,32), resize(0,32), resize(0,32), resize(0,32)} end macro;
macro head0 : signed :=resize(0,32) end macro;
macro head1 : signed :=resize(0,32) end macro;
macro head2 : signed :=resize(0,32) end macro;
macro next_read : signed :=resize(0,32) end macro;
macro state0 : states :=EMPTY end macro;
macro state1 : states :=EMPTY end macro;
macro state2 : states :=EMPTY end macro;
macro tail0 : signed :=resize(0,32) end macro;
macro tail1 : signed :=resize(0,32) end macro;
macro tail2 : signed :=resize(0,32) end macro;
...
prove:
	...
	at t_end: tail1 = ((tail1_at_t + 1)(31 downto 0) mod 3)(31 downto 0);
...
prove:
	...
	at t_end: head0 = ((head0_at_t + 1)(31 downto 0) mod 3)(31 downto 0);
	at t_end: head2 = ((head2_at_t + 1)(31 downto 0) mod 3)(31 downto 0);
	...
	at t_end: tail2 = ((tail2_at_t + 1)(31 downto 0) mod 3)(31 downto 0);
...
prove:
	...
	at t_end: tail0 = ((tail0_at_t + 1)(31 downto 0) mod 3)(31 downto 0);
	at t_end: val_0_sig = val_0_sig_at_t;
	at t_end: out_notify = true;
	at t_end: val_0_notify = true;
	at t_end: val_1_notify = false;
...
prove:
	...
	at t_end: head1 = ((head1_at_t + 1)(31 downto 0) mod 3)(31 downto 0);
