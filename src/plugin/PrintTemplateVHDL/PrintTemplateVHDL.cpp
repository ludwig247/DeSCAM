...
#include <PrintStmt.h>
#include "PrintTemplateVHDL.h"

std::map<std::string, std::string> PrintTemplateVHDL::printModel(Model *node) {
...
////////////////
std::string PrintTemplateVHDL::Text_types(std::string Name) {
...
std::string PrintTemplateVHDL::header(std::string Name) {
...
std::string PrintTemplateVHDL::entities(Module *node) {
...
std::string PrintTemplateVHDL::architecture_synch(Module *node) {
