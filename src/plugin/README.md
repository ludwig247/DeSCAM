The purpose of the plugins is to make use of the model generated by **SCAM** tool, starting from the *Electronic System Level* (ESL), and give a meaningful output to the end
