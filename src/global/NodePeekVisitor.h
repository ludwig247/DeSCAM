...
namespace DESCAM {
    ...
    public:
        ...
        ArrayOperand *nodePeekArrayOperand() const;
        ...
        Notify *nodePeekNotify() const;

        Wait *nodePeekWait() const;

        Peek *nodePeekPeek() const;

        ArrayExpr * nodePeekArrayExpr() const;

        TimePointOperand * nodePeekTimePointOperand() const;

        Ternary * nodePeekTernary() const;
        ...
        static ArrayOperand *nodePeekArrayOperand(Stmt *node);

        static Return *nodePeekReturn(Stmt *node);

        static Notify *nodePeekNotify(Stmt *node);

        static Wait *nodePeekWait(Stmt *node);

        static Peek *nodePeekPeek(Stmt *node);

        static ArrayExpr * nodePeekArrayExpr(Stmt *node);

        static TimePointOperand * nodePeekTimePointOperand(Stmt *node);

        static Ternary * nodePeekTernary(Stmt *node);
    ...
    private:
        ...
        ArrayOperand *nodePtrArrayOperand = nullptr;
        Notify *nodePtrNotify = nullptr;
        ...
        Ternary * nodePtrTernary = nullptr;
    ...
    public:
        ...
        virtual void visit(class Peek &node);
