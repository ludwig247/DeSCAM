 ...
 */
    ...
    public:
        ...
        static void
        createModel(int argc, const std::string &Binary, const std::string &srcFile, bool useOptimizer = false){
            ModelGlobal::optimizeCFG = useOptimizer;
