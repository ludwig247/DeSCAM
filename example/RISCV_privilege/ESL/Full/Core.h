...
public:
    ...
    Blocking<CUtoME_IF> mmu_bus_Channel;
    Blocking<MEtoCU_IF> bus_mmu_Channel;

    Blocking<MMU_in> ISA_to_MMU;
    Blocking<MMU_return> MMU_to_ISA;
    ...
    Core(sc_module_name name) :
            ...
            mmu_bus_Channel("mmu_bus_Channel"),
            bus_mmu_Channel("bus_mmu_Channel"),
            ...
            ISA_to_MMU("ISA_to_MMU"),
            MMU_to_ISA("MMU_to_ISA"),
        ...
        isa.toMemoryPort(ISA_to_MMU);
        mmu.isa_mmu(ISA_to_MMU);

        bus.isa_bus_Port(mmu_bus_Channel);
        mmu.mmu_mem(mmu_bus_Channel);

//        isa.fromMemoryPort(bus_isa_Channel);

        isa.fromMemoryPort(MMU_to_ISA);
        mmu.mmu_isa(MMU_to_ISA);

        mmu.mem_mmu(bus_mmu_Channel);
        bus.bus_isa_Port(bus_mmu_Channel);
