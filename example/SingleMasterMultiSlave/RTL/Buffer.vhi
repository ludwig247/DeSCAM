...
-- STATES -- 
macro run_0 : boolean :=
	section = run and bus_req_notify = '1' ;
 end macro;
macro run_1 : boolean :=
	section = run and bus_req_notify = '0' and bus_resp_notify = '0' and nb_result = true;
 end macro;
macro run_2 : boolean :=
	section = run and bus_req_notify = '0' and bus_resp_notify = '1' and nb_result = true;
 end macro;
...
prove:
	 at t_end: run_2;
	 at t_end: resp_data = value_in_sig_at_t;
