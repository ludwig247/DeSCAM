...
# Set path variable
#------------------
  set HOME /home/tobias/DeSCAM/example/
  set ROOT_PATH $HOME/operation-pipeline
  set RTL_PATH $ROOT_PATH/RTL
#  set MEMMODEL_PATH $ROOT_PATH/source/memory_model
  set PROP_PATH $RTL_PATH/properties_simple
...
#--------------------------------  
  ...
  read_itl $PROP_PATH/AHB_macros.vhi
  read_itl $PROP_PATH/AHB_simple.vhi
  read_itl $PROP_PATH/AHB_complex.vhi
  read_sva -completeness $PROP_PATH/AHB_comp.gfv
