...
void PLIC_Core::run() {
    while (true) {
        ...
        fromMemory_Claimed->slave_read(claimed_data, claimed_status);
        ...
        fromGateway_Int1->slave_read(pending_Int_1_data);
        fromGateway_Int2->slave_read(pending_Int_2_data);
