...
public:
    ...
    slave_out<unsigned  int[32]> fromRegsPort;
    // Ports for communication with ecallHandler
    slave_in<RegfileWriteType> ecall_reg_Port;
    slave_out<RegfileECallType> reg_ecall_Port;

    RegfileWriteType regfileWrite;
    unsigned int regfile[32]; // RegisterFile
    RegfileWriteType regfileECallWrite;
    RegfileECallType regfileECall; // RegisterFile{10,11,12,17}
...
void Regs::run() {
    ...
    while (true) {
        // return current data
        regfile[0] = 0;
        regfile[1] = reg_file_01;
        regfile[2] = reg_file_02;
        regfile[3] = reg_file_03;
        regfile[4] = reg_file_04;
        regfile[5] = reg_file_05;
        regfile[6] = reg_file_06;
        regfile[7] = reg_file_07;
        regfile[8] = reg_file_08;
        regfile[9] = reg_file_09;
        regfile[10] = reg_file_10;
        regfile[11] = reg_file_11;
        regfile[12] = reg_file_12;
        regfile[13] = reg_file_13;
        regfile[14] = reg_file_14;
        regfile[15] = reg_file_15;
        regfile[16] = reg_file_16;
        regfile[17] = reg_file_17;
        regfile[18] = reg_file_18;
        regfile[19] = reg_file_19;
        regfile[20] = reg_file_20;
        regfile[21] = reg_file_21;
        regfile[22] = reg_file_22;
        regfile[23] = reg_file_23;
        regfile[24] = reg_file_24;
        regfile[25] = reg_file_25;
        regfile[26] = reg_file_26;
        regfile[27] = reg_file_27;
        regfile[28] = reg_file_28;
        regfile[29] = reg_file_29;
        regfile[30] = reg_file_30;
        regfile[31] = reg_file_31;

        // return current data for ecall
        regfileECall.reg_file_10 = reg_file_10;
        regfileECall.reg_file_11 = reg_file_11;
        regfileECall.reg_file_12 = reg_file_12;
        regfileECall.reg_file_17 = reg_file_17;

        fromRegsPort->slave_write_array(regfile);
        reg_ecall_Port->slave_write(regfileECall);
        ...
        ecall_reg_Port->slave_read(regfileECallWrite, rec); // read request from ecall
        if (rec) {
            reg_file_10 = regfileECallWrite.dstData;
        }
    }
}
