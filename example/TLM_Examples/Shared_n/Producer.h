...
struct Producer : public sc_module {
    ...
    shared_out<example_data> out_1;
    shared_out<example_data> out_2;
    shared_out<example_data> out_3;
    shared_out<example_data> out_4;
    ...
    void fsm() {
        while (cnt < ITERATION_COUNT) {
            out_1->set(out_1_data);

            out_2->set(out_2_data);

            out_3->set(out_3_data);

            out_4->set(out_4_data);
    ...
    shared_out<int> out_1;
    shared_out<int> out_2;
    shared_out<int> out_3;
    shared_out<int> out_4;
    int out_1_data;
    int out_2_data;
    int out_3_data;
    int out_4_data;
