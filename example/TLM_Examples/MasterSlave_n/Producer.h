...
struct Producer : public sc_module {
    ...
    master_out<example_data> out_1;
    master_out<example_data> out_2;
    master_out<example_data> out_3;
    master_out<example_data> out_4;
    ...
    master_out<int> out_1;
    master_out<int> out_2;
    master_out<int> out_3;
    master_out<int> out_4;
    int out_1_data;
    int out_2_data;
    int out_3_data;
    int out_4_data;
...
struct Producer : public sc_module {
    ...
    slave_out<example_data> out_1;
    slave_out<example_data> out_2;
    slave_out<example_data> out_3;
    slave_out<example_data> out_4;
    example_data out_1_data;
    example_data out_2_data;
    example_data out_3_data;
    example_data out_4_data;
    ...
    void fsm() {
        while (cnt < ITERATION_COUNT) {
            out_1->slave_write(out_1_data);

            out_2->slave_write(out_2_data);

            out_3->slave_write(out_3_data);

            out_4->slave_write(out_4_data);

            cnt++;

            /// First iteration ends with wait, incrementing the data should appear in the next iteration
            wait(SC_ZERO_TIME);
#ifndef BIG_DATA
            out_1_data.array++;
            out_2_data.array++;
