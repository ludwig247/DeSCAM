...
# @author :	Luka
# @name   : 	slt.s
# @purpose: 	Test for set less than (slt)
...
_start:
	...
	slt  x3,x1,x31	    	# x3 = 0x01
	slt  x4,x1,x30	    	# x4 = 0x00
	slt  x5,x1,x29      	# x5 = 0x00
	slt  x6,x2,x28      	# x6 = 0x01
	slt  x7,x2,x0       	# x7 = 0x01
	slt  x8,x2,x27      	# x8 = 0x01
	slt  x9,x2,x26      	# x9 = 0x00
	slt  x10,x2,x29     	# x10 = 0x00
