...
//INFO: Same as FPI_Mastre.h but this time update_q is shared
...
struct FPI_Master : public sc_module {
    ...
    FPI_Master(sc_module_name name):
        ...
        shared_out<update_t> updateQ_o; // (1-cycle never blocks)
        ...
        shared_out<result_t> master_done;
        ...
        void fsm() {
            while (true) {
                ...
                if (section == IDLE) {
                    ...
                    if (updateQ_cycle_tmp) { updateQ_o->set(updateQ_msg_tmp); }
