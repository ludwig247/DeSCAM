...
read_verilog -golden  -pragma_ignore {}  -version sv2009 {riscv_load_store_unit.sv riscv_int_controller.sv riscv_controller.sv s2qed_riscv_core.sv s2qed_top_riscv_core.sv}
elaborate -golden
compile -golden
