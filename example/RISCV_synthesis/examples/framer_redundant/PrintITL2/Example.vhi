...
--macro frame_start_4 : boolean := true end macro;
--macro idle_5 : boolean := true end macro;
...
assume: 
	 at t: frame_start_2;
	 at t: (cnt = resize(21,32));
prove:
	 at t_end: frame_start_4;
	 at t_end: cnt = (-1 + cnt_at_t)(31 downto 0);
	 at t_end: msg_data = msg_data_at_t;
	 at t_end: s_out_sig = s_out_sig_at_t;
	 during[t+1, t_end-1]: b_in_notify = false;
...
property frame_start_4_read_7 is
dependencies: no_reset;
for timepoints:
	 t_end = t+1;
freeze:
...
property wait_frame_start_4 is
dependencies: no_reset;
freeze:
	cnt_at_t = cnt@t,
	msg_data_at_t = msg_data@t,
