...
/*
This example produces extra unreachable state that is seen as reachable by SCAM. OperationPruning should remove this state by detecting it is pointed by a vacuous operation. To detect this vacuous operation one level unroling should be enough.
*/
