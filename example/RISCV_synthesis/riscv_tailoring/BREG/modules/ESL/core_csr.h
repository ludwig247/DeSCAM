...
public:
    ...
    MasterSlave<RegfileType> REGtoISA_channel;
    ...
    Core(sc_module_name name) :
            ...
            REGtoISA_channel("REGtoISA_channel"),
        ...
        ISA_inst.RFtoISA_port(REGtoISA_channel);
        RF.RFtoISA_port(REGtoISA_channel);
        ISA_inst.ISAtoRF_port(toRegsChannel);
        RF.ISAtoRF_port(toRegsChannel);
