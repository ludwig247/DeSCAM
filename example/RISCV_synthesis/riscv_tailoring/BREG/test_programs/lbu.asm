...
/import/lab/users/morkunas/SCAM/example/RISCV_synthesis/riscv_tailoring/BREG/test_programs/lbu.elf:     file format elf32-littleriscv
...
00000000 <_start>:
  ...
  44:	0000cf83          	lbu	t6,0(ra)
  48:	0040cf03          	lbu	t5,4(ra)
  4c:	0030ce83          	lbu	t4,3(ra)
  50:	0070ce03          	lbu	t3,7(ra)
  54:	00000013          	nop
  58:	00000013          	nop
  5c:	00000013          	nop
  60:	00000013          	nop
