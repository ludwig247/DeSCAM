...
/import/lab/users/morkunas/SCAM/example/RISCV_synthesis/riscv_tailoring/BREG/test_programs/lb.elf:     file format elf32-littleriscv
...
00000000 <_start>:
  ...
  44:	00008f83          	lb	t6,0(ra)
  48:	00408f03          	lb	t5,4(ra)
  4c:	00308e83          	lb	t4,3(ra)
  50:	00708e03          	lb	t3,7(ra)
  54:	00000013          	nop
  58:	00000013          	nop
  5c:	00000013          	nop
  60:	00000013          	nop
