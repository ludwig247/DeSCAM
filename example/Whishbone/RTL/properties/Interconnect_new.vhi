...
macro nextphase : Interconnect_SECTIONS := section end macro;
...
macro state_58 : boolean := section = TRANSMITTING and helper = 0 end macro;
macro state_84 : boolean := section = DONE and helper = 0 end macro;
