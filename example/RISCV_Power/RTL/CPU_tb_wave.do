...
add wave -noupdate -height 15 -radix hexadecimal /cpu_tb/MemToCtl_port
...
add wave -noupdate -divider -height 30 {Control-Path to Decoder}
add wave -noupdate -height 15 -radix hexadecimal /cpu_tb/IF_CPU/CtlToDec_port
add wave -noupdate -height 15 /cpu_tb/IF_CPU/CtlToDec_port_sync
add wave -noupdate -height 15 /cpu_tb/IF_CPU/CtlToDec_port_notify
...
add wave -noupdate -height 15 -radix unsigned /cpu_tb/IF_CPU/IF_ALU/ALUtoCtl_data_signal
...
add wave -noupdate -height 15 -radix unsigned /cpu_tb/IF_CPU/IF_CPath/wb_data_signal
