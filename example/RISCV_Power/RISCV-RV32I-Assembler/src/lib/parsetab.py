...
_lr_action_items = {'$end':([1,2,4,10,14,16,20,21,22,],[0,-9,-1,-2,-6,-5,-7,-3,-4,]),'COMMA':([6,7,12,],[-8,9,15,]),'NEWLINE':([0,6,8,11,13,17,18,19,],[2,-8,10,14,16,20,21,22,]),'REGISTER':([3,9,15,],[6,6,6,]),'LABEL':([0,9,15,],[5,11,17,]),'COLUMN':([5,],[8,]),'IMMEDIATE':([9,15,],[13,19,]),'OPCODE':([0,],[3,]),}
...
_lr_goto_items = {'program':([0,],[1,]),'statement':([0,],[4,]),'register':([3,9,15,],[7,12,18,]),}
