...
macro b_in_notify_local : boolean := s2/b_in_notify end macro;
macro b_out_notify_local : boolean := s2/b_out_notify end macro;
...
-- PIPELINE SIGNALS --
macro b_out_free : boolean := s2/b_out_free end macro;
macro b_in_free : boolean := s2/b_in_free end macro;
...
-- STATES --
macro run_0 : boolean := s2/state=A end macro;
macro run_1 : boolean := s2/state=B end macro;
