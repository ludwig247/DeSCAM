...
-- DP SIGNALS -- 
macro fromMemoryPort_sig_loadedData : unsigned := MemToCtl_port.loadedData end macro; 
...
macro regfileWrite_dst : unsigned := CtlToRegs_port.dst end macro; 
macro regfileWrite_dstData : unsigned := CtlToRegs_port.dst_data end macro; 


-- STATES -- 
macro execute_4 : boolean := ((IF_CPath/section = writeMemory) and (CtlToMem_port.req = ME_WR)) end macro;
macro execute_10 : boolean := ((IF_CPath/section = writeMemory) and (CtlToMem_port.req = ME_RD)) end macro;
macro execute_11 : boolean := ((IF_CPath/section =  readMemory) and (CtlToMem_port.req = ME_RD)) end macro;
macro fetch_15 : boolean := (IF_CPath/section = requestInstr) end macro;
macro fetch_16 : boolean := (IF_CPath/section = receiveInstr) end macro;
...
property execute_10_write_1 is
dependencies: no_reset;
for timepoints:
	 t_end = t+1;
freeze:
...
prove:
	 ...
	 at t_end: pcReg = (4 + pcReg_at_t)(31 downto 0);
	 at t_end: regfileWrite_dst = getRdAddr(fromMemoryPort_sig_loadedData_at_t,getOpcode(fromMemoryPort_sig_loadedData_at_t));
	 at t_end: regfileWrite_dstData = getALUresult(ALU_COPY1,getImmediate(fromMemoryPort_sig_loadedData_at_t,getOpcode(fromMemoryPort_sig_loadedData_at_t)),0);
	 at t_end: toMemoryPort_sig_addrIn = (4 + pcReg_at_t)(31 downto 0);
	 at t_end: toMemoryPort_sig_dataIn = 0;
	 at t_end: toMemoryPort_sig_mask = MT_W;
	 at t_end: toMemoryPort_sig_req = ME_RD;
	 at t_end: toRegsPort_sig_dst = getRdAddr(fromMemoryPort_sig_loadedData_at_t,getOpcode(fromMemoryPort_sig_loadedData_at_t));
	 at t_end: toRegsPort_sig_dstData = getALUresult(ALU_COPY1,getImmediate(fromMemoryPort_sig_loadedData_at_t,getOpcode(fromMemoryPort_sig_loadedData_at_t)),0);
	 during[t+1, t_end]: fromMemoryPort_notify = false;
	 during[t+1, t_end-1]: toMemoryPort_notify = false;
	 at t_end: toMemoryPort_notify = true;
	 during[t+1, t_end-1]: toRegsPort_notify = false;
...
prove:
	 ...
	 at t_end: pcReg = (4 + pcReg_at_t)(31 downto 0);
	 at t_end: regfileWrite_dst = getRdAddr(fromMemoryPort_sig_loadedData_at_t,getOpcode(fromMemoryPort_sig_loadedData_at_t));
	 at t_end: regfileWrite_dstData = getALUresult(ALU_ADD,pcReg_at_t,getImmediate(fromMemoryPort_sig_loadedData_at_t,getOpcode(fromMemoryPort_sig_loadedData_at_t)));
	 at t_end: toMemoryPort_sig_addrIn = (4 + pcReg_at_t)(31 downto 0);
	 at t_end: toMemoryPort_sig_dataIn = 0;
	 at t_end: toMemoryPort_sig_mask = MT_W;
	 at t_end: toMemoryPort_sig_req = ME_RD;
	 at t_end: toRegsPort_sig_dst = getRdAddr(fromMemoryPort_sig_loadedData_at_t,getOpcode(fromMemoryPort_sig_loadedData_at_t));
	 at t_end: toRegsPort_sig_dstData = getALUresult(ALU_ADD,pcReg_at_t,getImmediate(fromMemoryPort_sig_loadedData_at_t,getOpcode(fromMemoryPort_sig_loadedData_at_t)));
	 during[t+1, t_end]: fromMemoryPort_notify = false;
	 during[t+1, t_end-1]: toMemoryPort_notify = false;
	 at t_end: toMemoryPort_notify = true;
	 during[t+1, t_end-1]: toRegsPort_notify = false;
