...
class Control_unit_new : public sc_module {
public:

    SC_HAS_PROCESS(Control_unit_new);

    Control_unit_new(sc_module_name name) :
...
void Control_unit_new::run() {
    ...
    while (true) {
        ...
        if (phase == memAccess) {
...
#endif
            nextphase = decodeInstr;
        }
        else if (phase == decodeInstr) {
            ...
            nextphase = setStallSignals;
        }
        else if (phase == setStallSignals) {

            DPtoCU_port->master_read(DPtoCU_data);
            ...
            nextphase = setDataPathSignals;
        }
        else if (phase == setDataPathSignals) {
            ...
            CUtoDP_port->master_write(CUtoDP_data);

            nextphase = updatePC;
        }
        else if (phase == updatePC) {
            ...
            nextphase = setDmemAccess;
        }
        else if (phase == setDmemAccess) {
...
PC_SelType Control_unit_new::getPCsel(unsigned int encodedInstr) const {
...
unsigned int Control_unit_new::getImmS2(unsigned int encodedInstr) const {
...
EncType Control_unit_new::getEncType(unsigned int encodedInstr) const {
...
InstrType Control_unit_new::getInstrType(unsigned int encodedInstr) const {
...
RF_RD_AccessType Control_unit_new::getRegFileReqS2(unsigned int encodedInstr) const {
...
unsigned int Control_unit_new::getRegRs1Addr(unsigned int encodedInstr) const {
...
unsigned int Control_unit_new::getRegRs2Addr(unsigned int encodedInstr) const {
...
unsigned int Control_unit_new::getRegRdAddr(unsigned int encodedInstr) const {
...
ALUfuncType Control_unit_new::getALUfunc(unsigned int encodedInstr) const {
...
AL_OperandSelType Control_unit_new::getALUop1Sel(unsigned int encodedInstr) const {
...
AL_OperandSelType Control_unit_new::getALUop2Sel(unsigned int encodedInstr) const {
...
unsigned int Control_unit_new::getImmS5(unsigned int encodedInstr) const {
...
ME_AccessType Control_unit_new::getDmemReq(unsigned int encodedInstr) const {
...
ME_MaskType Control_unit_new::getDmemMask(unsigned int encodedInstr) const {
...
RF_WR_AccessType Control_unit_new::getRegFileReqS5(unsigned int encodedInstr) const {
...
RF_WriteDataSelType Control_unit_new::getRegFileWriteDataSel(unsigned int encodedInstr) const {
...
bool Control_unit_new::getBranchEvaluation(InstrType instrType, unsigned int reg1Content, unsigned int reg2Content) const {
...
bool Control_unit_new::getStallOnce(EncType currEncType, EncType prevEncType, unsigned int regRs1Addr, unsigned int regRs2Addr, unsigned int regRdAddr) const {
...
bool Control_unit_new::getStallTwice(EncType currEncType, EncType prevEncType, unsigned int regRs1Addr, unsigned int regRs2Addr, unsigned int regRdAddr) const {
...
unsigned int Control_unit_new::getPC(PC_SelType pcSel, unsigned int imm, bool branchTaken, unsigned int reg1Content, unsigned int pcReg) const {
