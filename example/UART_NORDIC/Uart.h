...
SC_MODULE(Uart)
{
    ...
    Shared<tx_control_in_t>  control_from_tx;
    Shared<tx_control_out_t> control_to_tx;
    Shared<rx_control_in_t>  control_from_rx;
    Shared<rx_control_out_t> control_to_rx;
    Shared<config_t>         config_to_tx;
    Shared<config_t>         config_to_rx;
