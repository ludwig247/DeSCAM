...
void ISA_new::run() {
    ...
    while (true) {
        ...
        if (phase == Phases::fetch_PH) {
            ...
            toMemoryPort->write(memoryAccess, "Fetch_Req"); //Send request to memory
            fromMemoryPort->read(fromMemoryData, "Fetch_Read_Instr"); //Read encoded instruction from memory
            ...
            if (getEncType(encodedInstr) == ENC_R) {
                ...
                fromRegsPort->master_read(regfile, "ENC_R_read");
                ...
                toRegsPort->master_write(regfileWrite, "ENC_R_write"); //Perform write back
                ...
                //Set-up operands for alu by reading from regfile
                fromRegsPort->master_read(regfile, "ENC_B_read");
                aluOp1 = regfile[RS1_FIELD(encodedInstr)];
                aluOp2 = regfile[RS2_FIELD(encodedInstr)];
                ...
                //Set-up operands for alu by reading from regfile
                fromRegsPort->master_read(regfile, "ENC_S_read");
                aluOp1 = regfile[RS1_FIELD(encodedInstr)];
                ...
                // Store done
                fromMemoryPort->read(fromMemoryData, "Store1_done"); //Fixme: Why do we need this read? For store a write should be sufficient
                ...
                toRegsPort->master_write(regfileWrite, "ENC_U_write"); //Perform write back
                ...
                toRegsPort->master_write(regfileWrite, "ENC_J_write"); //Perform write back
                ...
                toRegsPort->master_write(regfileWrite, "ENC_I_I_write"); //Perform write back
                ...
                //Set-up operands for alu by reading from regfile
                fromRegsPort->master_read(regfile,"ENC_I_L_read");
                aluOp1 = regfile[RS1_FIELD(encodedInstr)];
                aluOp2 = getImmediate(encodedInstr);
                ...
                // Request load
                toMemoryPort->write(memoryAccess, "Load_Req");
                ...
                //Perform write back
                toRegsPort->master_write(regfileWrite, "ENC_I_L_write");
                ...
                /////////////////////////////////////////////////////////////////////////////
                fromRegsPort->master_read(regfile, "ENC_I_J_read");
