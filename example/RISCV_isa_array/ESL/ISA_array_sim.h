    ...
    while (true) {
        ...
        if (phase == Phases::fetch_PH) {
            ...
            if (getEncType(encodedInstr) == ENC_R) {
                ...
                fromRegsPort->master_read_array(regfile, "ENC_R_read");
                ...
                //Set-up operands for alu by reading from regfile
                fromRegsPort->master_read_array(regfile, "ENC_B_read");
                aluOp1 = regfile[RS1_FIELD(encodedInstr)];
                aluOp2 = regfile[RS2_FIELD(encodedInstr)];
                ...
                //Set-up operands for alu by reading from regfile
                fromRegsPort->master_read_array(regfile, "ENC_S_read");
                aluOp1 = regfile[RS1_FIELD(encodedInstr)];
                ...
                //Set-up operands for alu by reading from regfile
                fromRegsPort->master_read_array(regfile, "ENC_I_I_read");
                aluOp1 = regfile[RS1_FIELD(encodedInstr)];
                aluOp2 = regfile[RS2_FIELD(encodedInstr)];
                ...
                //Set-up operands for alu by reading from regfile
                fromRegsPort->master_read_array(regfile, "ENC_I_L_read");
                aluOp1 = regfile[RS1_FIELD(encodedInstr)];
                aluOp2 = getImmediate(encodedInstr);
