    ...
    while (true) {
        ...
        if (phase == Phases::fetch_PH) {
            ...
            if (getEncType(encodedInstr) == ENC_R) {
                ...
                fromRegsPort->master_read(regfile, "ENC_R_read"); //Read register contents
                ...
                fromRegsPort->master_read(regfile, "ENC_B_read"); //Read register contents
                ...
                fromRegsPort->master_read(regfile, "ENC_S_read"); //Read register contents
                ...
                toRegsPort->master_write(regfileWrite, "ENC_S_write"); //Perform write back
                ...
                fromRegsPort->master_read(regfile, "ENC_I_I_read"); //Read register contents
                ...
                fromRegsPort->master_read(regfile, "ENC_I_L_read"); //Read register contents
                ...
                fromRegsPort->master_read(regfile, "ENC_I_J_read"); //Read register contents
                ...
                //Perform write back
                toRegsPort->master_write(regfileWrite, "ENC_I_J_write");
