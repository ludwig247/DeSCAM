...
unsigned int ISA_new::readRegfile(unsigned int src, RegfileType regfile) const {
    ...
    if (src == 0) {
        ...
        return regfile.regfile[0];
    } else if (src == 2) {
        return regfile.regfile[1];
    } else if (src == 3) {
        return regfile.regfile[2];
    } else if (src == 4) {
        return regfile.regfile[3];
    } else if (src == 5) {
        return regfile.regfile[4];
    } else if (src == 6) {
        return regfile.regfile[5];
    } else if (src == 7) {
        return regfile.regfile[6];
    } else if (src == 8) {
        return regfile.regfile[7];
    } else if (src == 9) {
        return regfile.regfile[8];
    } else if (src == 10) {
        return regfile.regfile[9];
    } else if (src == 11) {
        return regfile.regfile[10];
    } else if (src == 12) {
        return regfile.regfile[11];
    } else if (src == 13) {
        return regfile.regfile[12];
    } else if (src == 14) {
        return regfile.regfile[13];
    } else if (src == 15) {
        return regfile.regfile[14];
    } else if (src == 16) {
        return regfile.regfile[15];
    } else if (src == 17) {
        return regfile.regfile[16];
    } else if (src == 18) {
        return regfile.regfile[17];
    } else if (src == 19) {
        return regfile.regfile[18];
    } else if (src == 20) {
        return regfile.regfile[19];
    } else if (src == 21) {
        return regfile.regfile[20];
    } else if (src == 22) {
        return regfile.regfile[21];
    } else if (src == 23) {
        return regfile.regfile[22];
    } else if (src == 24) {
        return regfile.regfile[23];
    } else if (src == 25) {
        return regfile.regfile[24];
    } else if (src == 26) {
        return regfile.regfile[25];
    } else if (src == 27) {
        return regfile.regfile[26];
    } else if (src == 28) {
        return regfile.regfile[27];
    } else if (src == 29) {
        return regfile.regfile[28];
    } else if (src == 30) {
        return regfile.regfile[29];
    } else {
        return regfile.regfile[30];
    }
}
