...
/import/lab/users/morkunas/SCAM/example/RISCV_synthesis/riscv_tailoring/BREG/test_programs/lw.elf:     file format elf32-littleriscv
...
00000000 <_start>:
  ...
  44:	0000af83          	lw	t6,0(ra)
  48:	0040af03          	lw	t5,4(ra)
  4c:	0020ae83          	lw	t4,2(ra)
  50:	00000013          	nop
  54:	00000013          	nop
  58:	00000013          	nop
  5c:	00000013          	nop
