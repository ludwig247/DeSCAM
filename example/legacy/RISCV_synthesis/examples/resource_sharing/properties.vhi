...
-- DP SIGNALS --
macro ALUtoCtl_port_sig_ALU_result : unsigned := ALUtoCtl_port_sig.ALU_result end macro;
macro CtlToALU_port_sig_alu_fun : ALU_function := CtlToALU_port_sig.alu_fun end macro;
macro CtlToALU_port_sig_imm : unsigned := CtlToALU_port_sig.imm end macro;
macro CtlToALU_port_sig_op1_sel : ALUopType := CtlToALU_port_sig.op1_sel end macro;
macro CtlToALU_port_sig_op2_sel : ALUopType := CtlToALU_port_sig.op2_sel end macro;
macro CtlToALU_port_sig_pc_reg : unsigned := CtlToALU_port_sig.pc_reg end macro;
macro CtlToALU_port_sig_reg1_contents : unsigned := CtlToALU_port_sig.reg1_contents end macro;
macro CtlToALU_port_sig_reg2_contents : unsigned := CtlToALU_port_sig.reg2_contents end macro;
