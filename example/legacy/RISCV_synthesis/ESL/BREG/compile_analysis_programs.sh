...
OUTPUT_DIR=$SCAM_HOME/example/RISCV_synthesis/ESL/BREG/analysis_programs
BREG_DIR=$SCAM_HOME/example/RISCV_synthesis/ESL/BREG

mkdir -p ${OUTPUT_DIR}

for filepath in $BREG_DIR/analysis_programs/*.cpp
do
	filename=${filepath##*/}
