...
struct Options {
    ...
    addr_t mem_size           = 1024*1024*128;  // 512 ram, to place it at 0x80000000, where ricv-tests places program code
    addr_t mem_start_addr     = 0x80000000;
    addr_t mem_end_addr       = mem_start_addr + mem_size;
    addr_t dtb_rom_size       = 0x00002000;
    addr_t dtb_rom_start      = 0x00001000;
    addr_t dtb_rom_end        = dtb_rom_start + dtb_rom_size;
    addr_t clint_start_addr   = 0x02000000;
    addr_t clint_end_addr     = 0x0200ffff;
//    addr_t term_start_addr    = 0x20000000;
 //   addr_t term_end_addr      = term_start_addr + 16;
    addr_t plic_start_addr    = 0x0C000000;
    addr_t plic_end_addr      = 0x0C200008;
