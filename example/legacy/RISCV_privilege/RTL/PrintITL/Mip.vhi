...
macro MSIP_port_sig : boolean := end macro; 
...
prove:
	 at t+1: run_0;
	 at t+1: mip = manageBit(MEIP_port_sig_at_t,manageBit(MTIP_port_sig_at_t,manageBit(MSIP_port_sig_at_t,mip_at_t,3),7),11);
	 at t+1: mip_isa_Port_sig = manageBit(MEIP_port_sig_at_t,manageBit(MTIP_port_sig_at_t,manageBit(MSIP_port_sig_at_t,mip_at_t,3),7),11);
end property;