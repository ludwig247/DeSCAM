...
macro ecall_reg_Port_notify :  boolean  := end macro; 
macro fromMemoryPort_notify :  boolean  := end macro; 
macro fromMemoryPort_sync   :  boolean  := end macro; 
macro isa_ecall_Port_notify :  boolean  := end macro; 
macro isa_ecall_Port_sync   :  boolean  := end macro; 
macro toMemoryPort_notify :  boolean  := end macro; 
macro toMemoryPort_sync   :  boolean  := end macro; 


-- DP SIGNALS -- 
macro ecall_isa_Port_sig : boolean := end macro; 
...
macro isa_ecall_Port_sig : boolean := end macro; 
...
-- VISIBLE REGISTERS --
macro ans : unsigned := end macro; 
macro index : unsigned := end macro; 
...
macro regfileSyscall_reg_file_11 : unsigned := end macro; 
macro regfileSyscall_reg_file_12 : unsigned := end macro; 
macro regfileWrite_exception : unsigned := end macro; 
macro sysRES : boolean := end macro; 


-- STATES -- 
macro idle_0 : boolean := true end macro;
macro process_2 : boolean := true end macro;
macro process_3 : boolean := true end macro;
macro writing_4 : boolean := true end macro;
macro writing_5 : boolean := true end macro;
macro writing_7 : boolean := true end macro;
...
prove:
	 ...
	 at t: regfileWrite_exception = resize(0,32);
	 at t: sysRES = false;
	 at t: ecall_isa_Port_notify = false;
	 at t: ecall_reg_Port_notify = false;
	 at t: fromMemoryPort_notify = false;
	 at t: isa_ecall_Port_notify = true;
...
freeze:
	...
	reg_ecall_Port_sig_reg_file_11_at_t = reg_ecall_Port_sig_reg_file_11@t,
	reg_ecall_Port_sig_reg_file_12_at_t = reg_ecall_Port_sig_reg_file_12@t,
	regfileWrite_exception_at_t = regfileWrite_exception@t;
assume: 
	 at t: idle_0;
	 at t: (reg_ecall_Port_sig_reg_file_17 = resize(93,32));
	 at t: isa_ecall_Port_sync;
prove:
	 at t_end: process_2;
	 at t_end: ans = ans_at_t;
	 at t_end: ecall_isa_Port_sig = false;
	 ...
	 at t_end: regfileSyscall_reg_file_11 = reg_ecall_Port_sig_reg_file_11_at_t;
	 at t_end: regfileSyscall_reg_file_12 = reg_ecall_Port_sig_reg_file_12_at_t;
	 at t_end: regfileWrite_exception = regfileWrite_exception_at_t;
	 at t_end: sysRES = false;
	 during[t+1, t_end-1]: ecall_isa_Port_notify = false;
	 at t_end: ecall_isa_Port_notify = true;
	 during[t+1, t_end]: ecall_reg_Port_notify = false;
	 during[t+1, t_end]: fromMemoryPort_notify = false;
	 during[t+1, t_end]: isa_ecall_Port_notify = false;
...
assume: 
	 at t: idle_0;
	 at t: not((reg_ecall_Port_sig_reg_file_17 = resize(93,32)));
	 at t: not((reg_ecall_Port_sig_reg_file_17 = resize(64,32)));
	 at t: isa_ecall_Port_sync;
prove:
	 at t_end: process_3;
	 at t_end: ans = ans_at_t;
	 at t_end: ecall_isa_Port_sig = true;
	 at t_end: index = index_at_t;
	 at t_end: memoryAccess_addrIn = memoryAccess_addrIn_at_t;
	 at t_end: memoryAccess_dataIn = memoryAccess_dataIn_at_t;
	 at t_end: memoryAccess_mask = memoryAccess_mask_at_t;
...
assume: 
	 at t: idle_0;
	 at t: not((reg_ecall_Port_sig_reg_file_12 = resize(0,32)));
	 at t: (reg_ecall_Port_sig_reg_file_17 = resize(64,32));
	 at t: isa_ecall_Port_sync;
prove:
	 at t_end: writing_4;
	 at t_end: ans = reg_ecall_Port_sig_reg_file_12_at_t;
	 at t_end: index = 0;
	 at t_end: memoryAccess_addrIn = reg_ecall_Port_sig_reg_file_11_at_t;
	 ...
	 at t_end: toMemoryPort_sig_addrIn = reg_ecall_Port_sig_reg_file_11_at_t;
	 at t_end: toMemoryPort_sig_dataIn = 0;
	 at t_end: toMemoryPort_sig_mask = MT_BU;
	 at t_end: toMemoryPort_sig_req = ME_RD;
	 during[t+1, t_end]: ecall_isa_Port_notify = false;
	 during[t+1, t_end]: ecall_reg_Port_notify = false;
	 during[t+1, t_end]: fromMemoryPort_notify = false;
	 during[t+1, t_end]: isa_ecall_Port_notify = false;
...
assume: 
	 at t: idle_0;
	 at t: (reg_ecall_Port_sig_reg_file_12 = resize(0,32));
	 at t: (reg_ecall_Port_sig_reg_file_17 = resize(64,32));
	 at t: isa_ecall_Port_sync;
prove:
	 at t_end: writing_7;
	 at t_end: ans = reg_ecall_Port_sig_reg_file_12_at_t;
	 at t_end: ecall_isa_Port_sig = true;
	 at t_end: ecall_reg_Port_sig_dst = 0;
	 at t_end: ecall_reg_Port_sig_dstData = reg_ecall_Port_sig_reg_file_12_at_t;
	 at t_end: ecall_reg_Port_sig_exception = regfileWrite_exception_at_t;
	 at t_end: index = 0;
	 at t_end: memoryAccess_addrIn = memoryAccess_addrIn_at_t;
	 at t_end: memoryAccess_dataIn = memoryAccess_dataIn_at_t;
	 at t_end: memoryAccess_mask = memoryAccess_mask_at_t;
	 ...
	 during[t+1, t_end-1]: ecall_isa_Port_notify = false;
	 at t_end: ecall_isa_Port_notify = true;
	 during[t+1, t_end-1]: ecall_reg_Port_notify = false;
	 at t_end: ecall_reg_Port_notify = true;
	 during[t+1, t_end]: fromMemoryPort_notify = false;
	 during[t+1, t_end]: isa_ecall_Port_notify = false;
	 during[t+1, t_end]: toMemoryPort_notify = false;
end property;
...
prove:
	 ...
	 during[t+1, t_end]: ecall_reg_Port_notify = false;
	 during[t+1, t_end]: fromMemoryPort_notify = false;
	 during[t+1, t_end-1]: isa_ecall_Port_notify = false;
	 at t_end: isa_ecall_Port_notify = true;
	 during[t+1, t_end]: toMemoryPort_notify = false;
end property;
...
prove:
	 ...
	 at t_end: ecall_isa_Port_sig = true;
	 at t_end: ecall_reg_Port_sig_dst = 0;
	 at t_end: ecall_reg_Port_sig_dstData = ans_at_t;
	 at t_end: ecall_reg_Port_sig_exception = regfileWrite_exception_at_t;
	 at t_end: index = (1 + index_at_t)(31 downto 0);
	 at t_end: memoryAccess_addrIn = memoryAccess_addrIn_at_t;
	 at t_end: memoryAccess_dataIn = memoryAccess_dataIn_at_t;
...
prove:
	 ...
	 at t+1: regfileWrite_exception = regfileWrite_exception_at_t;
	 at t+1: sysRES = sysRES_at_t;
	 at t+1: ecall_isa_Port_notify = false;
	 at t+1: ecall_reg_Port_notify = false;
	 at t+1: fromMemoryPort_notify = false;
	 at t+1: isa_ecall_Port_notify = true;
...
assume: 
	 at t: process_2;
	 at t: not(ecall_isa_Port_sync);
prove:
	 at t+1: process_2;
	 at t+1: ans = ans_at_t;
	 at t+1: ecall_isa_Port_sig = sysRES_at_t;
	 at t+1: index = index_at_t;
	 at t+1: memoryAccess_addrIn = memoryAccess_addrIn_at_t;
	 at t+1: memoryAccess_dataIn = memoryAccess_dataIn_at_t;
	 at t+1: memoryAccess_mask = memoryAccess_mask_at_t;
	 ...
	 at t+1: regfileWrite_exception = regfileWrite_exception_at_t;
	 at t+1: sysRES = sysRES_at_t;
	 at t+1: ecall_isa_Port_notify = true;
	 at t+1: ecall_reg_Port_notify = false;
	 at t+1: fromMemoryPort_notify = false;
	 at t+1: isa_ecall_Port_notify = false;
	 at t+1: toMemoryPort_notify = false;
end property;
