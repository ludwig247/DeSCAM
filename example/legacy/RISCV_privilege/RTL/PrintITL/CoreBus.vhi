...
macro bus_ecall_Port_notify :  boolean  := end macro; 
macro bus_ecall_Port_sync   :  boolean  := end macro; 
macro bus_isa_Port_notify :  boolean  := end macro; 
macro bus_isa_Port_sync   :  boolean  := end macro; 
macro ecall_bus_Port_notify :  boolean  := end macro; 
macro ecall_bus_Port_sync   :  boolean  := end macro; 
...
macro bus_ecall_Port_sig_loadedData : unsigned := end macro; 
macro bus_isa_Port_sig_loadedData : unsigned := end macro; 
macro ecall_bus_Port_sig_addrIn : unsigned := end macro; 
macro ecall_bus_Port_sig_dataIn : unsigned := end macro; 
macro ecall_bus_Port_sig_mask : ME_MaskType := end macro; 
macro ecall_bus_Port_sig_req : ME_AccessType := end macro; 
...
prove:
	 ...
	 at t: bus_ecall_Port_notify = false;
	 at t: bus_isa_Port_notify = false;
	 at t: ecall_bus_Port_notify = false;
...
assume: 
	 ...
	 at t: ((isa_bus_Port_sig_addrIn >= unsigned(resize(-2147483648,32))) and (isa_bus_Port_sig_addrIn < (unsigned(resize(-2147483648,32)) + resize(536870912,32))(31 downto 0)));
	 at t: isa_bus_Port_sync;
prove:
	 at t_end: run_1;
	 ...
	 during[t+1, t_end]: bus_ecall_Port_notify = false;
	 during[t+1, t_end]: bus_isa_Port_notify = false;
	 during[t+1, t_end]: ecall_bus_Port_notify = false;
...
prove:
	 ...
	 during[t+1, t_end]: bus_ecall_Port_notify = false;
	 during[t+1, t_end]: bus_isa_Port_notify = false;
	 during[t+1, t_end-1]: ecall_bus_Port_notify = false;
	 at t_end: ecall_bus_Port_notify = true;
	 during[t+1, t_end]: isa_bus_Port_notify = false;
end property;
...
assume: 
	 at t: run_0;
	 at t: isa_bus_Port_sync;
	 at t: not(((isa_bus_Port_sig_addrIn >= unsigned(resize(-2147483648,32))) and (isa_bus_Port_sig_addrIn < (unsigned(resize(-2147483648,32)) + resize(536870912,32))(31 downto 0))));
	 at t: not(((isa_bus_Port_sig_addrIn >= resize(268513280,32)) and (isa_bus_Port_sig_addrIn < resize(268517375,32))));
	 at t: not(((isa_bus_Port_sig_addrIn >= resize(4096,32)) and (isa_bus_Port_sig_addrIn < (resize(4096,32) + resize(8192,32))(31 downto 0))));
	 at t: not(((isa_bus_Port_sig_addrIn >= resize(33554432,32)) and (isa_bus_Port_sig_addrIn < resize(33619968,32))));
	 at t: not(((isa_bus_Port_sig_addrIn >= resize(201326592,32)) and (isa_bus_Port_sig_addrIn < resize(203423752,32))));
	 at t: isa_bus_Port_sync;
prove:
	 at t_end: run_4;
	 at t_end: CPtoME_data_addrIn = isa_bus_Port_sig_addrIn_at_t;
...
assume: 
	 ...
	 at t: isa_bus_Port_sync;
	 at t: not(((isa_bus_Port_sig_addrIn >= unsigned(resize(-2147483648,32))) and (isa_bus_Port_sig_addrIn < (unsigned(resize(-2147483648,32)) + resize(536870912,32))(31 downto 0))));
	 at t: ((isa_bus_Port_sig_addrIn >= resize(268513280,32)) and (isa_bus_Port_sig_addrIn < resize(268517375,32)));
	 at t: isa_bus_Port_sync;
prove:
	 at t_end: run_8;
	 at t_end: BUStoMEM_port_sig_addrIn = isa_bus_Port_sig_addrIn_at_t;
...
assume: 
	 ...
	 at t: not(((isa_bus_Port_sig_addrIn >= unsigned(resize(-2147483648,32))) and (isa_bus_Port_sig_addrIn < (unsigned(resize(-2147483648,32)) + resize(536870912,32))(31 downto 0))));
	 at t: not(((isa_bus_Port_sig_addrIn >= resize(268513280,32)) and (isa_bus_Port_sig_addrIn < resize(268517375,32))));
	 at t: ((isa_bus_Port_sig_addrIn >= resize(4096,32)) and (isa_bus_Port_sig_addrIn < (resize(4096,32) + resize(8192,32))(31 downto 0)));
	 at t: isa_bus_Port_sync;
prove:
	 at t_end: run_11;
	 at t_end: BUStoMEM_port_sig_addrIn = isa_bus_Port_sig_addrIn_at_t;
...
assume: 
	 ...
	 at t: not(((isa_bus_Port_sig_addrIn >= resize(268513280,32)) and (isa_bus_Port_sig_addrIn < resize(268517375,32))));
	 at t: not(((isa_bus_Port_sig_addrIn >= resize(4096,32)) and (isa_bus_Port_sig_addrIn < (resize(4096,32) + resize(8192,32))(31 downto 0))));
	 at t: ((isa_bus_Port_sig_addrIn >= resize(33554432,32)) and (isa_bus_Port_sig_addrIn < resize(33619968,32)));
	 at t: isa_bus_Port_sync;
prove:
	 at t_end: run_14;
...
assume: 
	 ...
	 at t: not(((isa_bus_Port_sig_addrIn >= resize(4096,32)) and (isa_bus_Port_sig_addrIn < (resize(4096,32) + resize(8192,32))(31 downto 0))));
	 at t: not(((isa_bus_Port_sig_addrIn >= resize(33554432,32)) and (isa_bus_Port_sig_addrIn < resize(33619968,32))));
	 at t: ((isa_bus_Port_sig_addrIn >= resize(201326592,32)) and (isa_bus_Port_sig_addrIn < resize(203423752,32)));
	 at t: isa_bus_Port_sync;
prove:
	 at t_end: run_17;
...
freeze:
	MEtoCP_data_loadedData_at_t = MEtoCP_data_loadedData@t,
	ecall_bus_Port_sig_addrIn_at_t = ecall_bus_Port_sig_addrIn@t,
	ecall_bus_Port_sig_dataIn_at_t = ecall_bus_Port_sig_dataIn@t,
	ecall_bus_Port_sig_mask_at_t = ecall_bus_Port_sig_mask@t,
	ecall_bus_Port_sig_req_at_t = ecall_bus_Port_sig_req@t;
assume: 
	 at t: run_4;
	 at t: ecall_bus_Port_sync;
	 at t: not(((ecall_bus_Port_sig_addrIn >= unsigned(resize(-2147483648,32))) and (ecall_bus_Port_sig_addrIn < (unsigned(resize(-2147483648,32)) + resize(536870912,32))(31 downto 0))));
	 at t: ecall_bus_Port_sync;
prove:
	 at t_end: run_0;
	 at t_end: CPtoME_data_addrIn = ecall_bus_Port_sig_addrIn_at_t;
	 at t_end: CPtoME_data_dataIn = ecall_bus_Port_sig_dataIn_at_t;
	 at t_end: CPtoME_data_mask = ecall_bus_Port_sig_mask_at_t;
	 at t_end: CPtoME_data_req = ecall_bus_Port_sig_req_at_t;
	 at t_end: MEtoCP_data_loadedData = MEtoCP_data_loadedData_at_t;
	 during[t+1, t_end]: BUStoCLINT_port_notify = false;
	 during[t+1, t_end]: BUStoMEM_port_notify = false;
	 during[t+1, t_end]: BUStoPLIC_port_notify = false;
...
assume: 
	 at t: run_4;
	 at t: ecall_bus_Port_sync;
	 at t: ((ecall_bus_Port_sig_addrIn >= unsigned(resize(-2147483648,32))) and (ecall_bus_Port_sig_addrIn < (unsigned(resize(-2147483648,32)) + resize(536870912,32))(31 downto 0)));
	 at t: ecall_bus_Port_sync;
prove:
	 at t_end: run_5;
	 at t_end: BUStoMEM_port_sig_addrIn = ecall_bus_Port_sig_addrIn_at_t;
	 at t_end: BUStoMEM_port_sig_dataIn = ecall_bus_Port_sig_dataIn_at_t;
	 at t_end: BUStoMEM_port_sig_mask = ecall_bus_Port_sig_mask_at_t;
	 at t_end: BUStoMEM_port_sig_req = ecall_bus_Port_sig_req_at_t;
	 at t_end: CPtoME_data_addrIn = ecall_bus_Port_sig_addrIn_at_t;
	 at t_end: CPtoME_data_dataIn = ecall_bus_Port_sig_dataIn_at_t;
	 at t_end: CPtoME_data_mask = ecall_bus_Port_sig_mask_at_t;
	 at t_end: CPtoME_data_req = ecall_bus_Port_sig_req_at_t;
...
prove:
	 ...
	 at t_end: CPtoME_data_req = CPtoME_data_req_at_t;
	 at t_end: MEtoCP_data_loadedData = MEMtoBUS_port_sig_loadedData_at_t;
	 at t_end: bus_ecall_Port_sig_loadedData = MEMtoBUS_port_sig_loadedData_at_t;
	 during[t+1, t_end]: BUStoCLINT_port_notify = false;
	 during[t+1, t_end]: BUStoMEM_port_notify = false;
	 during[t+1, t_end]: BUStoPLIC_port_notify = false;
	 during[t+1, t_end]: CLINTtoBUS_port_notify = false;
	 during[t+1, t_end]: MEMtoBUS_port_notify = false;
	 during[t+1, t_end]: PLICtoBUS_port_notify = false;
	 during[t+1, t_end-1]: bus_ecall_Port_notify = false;
	 at t_end: bus_ecall_Port_notify = true;
	 during[t+1, t_end]: bus_isa_Port_notify = false;
	 during[t+1, t_end]: ecall_bus_Port_notify = false;
	 during[t+1, t_end]: isa_bus_Port_notify = false;
end property;
...
prove:
	 ...
	 at t+1: bus_ecall_Port_notify = false;
	 at t+1: bus_isa_Port_notify = false;
	 at t+1: ecall_bus_Port_notify = false;
...
prove:
	 ...
	 at t+1: CPtoME_data_req = CPtoME_data_req_at_t;
	 at t+1: MEtoCP_data_loadedData = MEtoCP_data_loadedData_at_t;
	 at t+1: bus_ecall_Port_sig_loadedData = MEtoCP_data_loadedData_at_t;
	 at t+1: BUStoCLINT_port_notify = false;
	 at t+1: BUStoMEM_port_notify = false;
	 at t+1: BUStoPLIC_port_notify = false;
	 at t+1: CLINTtoBUS_port_notify = false;
	 at t+1: MEMtoBUS_port_notify = false;
	 at t+1: PLICtoBUS_port_notify = false;
	 at t+1: bus_ecall_Port_notify = true;
	 at t+1: bus_isa_Port_notify = false;
	 at t+1: ecall_bus_Port_notify = false;
	 at t+1: isa_bus_Port_notify = false;
end property;
