...
-- STATES -- 
macro instrFetch_0 : boolean := CU/section = writeMem  end macro;
macro instrFetch_1 : boolean := CU/section = readMem   end macro;
macro memAccess_2  : boolean := CU/section = writeDmem end macro;
macro memAccess_3  : boolean := CU/section = readDmem  end macro;
