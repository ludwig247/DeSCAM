...
property instrFetch_0_write_0 is
...
property instrFetch_1_read_1 is
dependencies: no_reset;
for timepoints:
	 t_end = t+1;
freeze:
...
property instrFetch_1_read_2 is
dependencies: no_reset;
for timepoints:
	 t_end = t+1;
freeze:
...
assume: 
	 at t: instrFetch_1;
	 at t: not(CS_3_s3_regfileWrite);
	 at t: ((getEncType(MEtoCU_port_sig_loadedData) = ENC_I_L) or (getEncType(MEtoCU_port_sig_loadedData) = ENC_S));
	 at t: (getEncType(MEtoCU_port_sig_loadedData) = ENC_S);
	 at t: MEtoCU_port_sync;
prove:
	 at t_end: memAccess_2;
	 at t_end: CS_2_s2_aluFunc = getALUfunc(MEtoCU_port_sig_loadedData_at_t);
	 at t_end: CS_2_s2_aluOp1Sel = getALUop1Sel(MEtoCU_port_sig_loadedData_at_t);
	 at t_end: CS_2_s2_aluOp2Sel = getALUop2Sel(MEtoCU_port_sig_loadedData_at_t);
	 at t_end: CS_3_s2_regfileWrite = getRegfileWriteReq(MEtoCU_port_sig_loadedData_at_t);
...
property instrFetch_1_read_3 is
dependencies: no_reset;
for timepoints:
	 t_end = t+1;
freeze:
...
property instrFetch_1_read_4 is
dependencies: no_reset;
for timepoints:
	 t_end = t+1;
freeze:
...
property instrFetch_1_read_5 is
dependencies: no_reset;
for timepoints:
	 t_end = t+1;
freeze:
...
property instrFetch_1_read_6 is
dependencies: no_reset;
for timepoints:
	 t_end = t+1;
freeze:
...
property memAccess_2_write_7 is
dependencies: no_reset;
for timepoints:
	 t_end = t+1;
freeze:
...
property memAccess_3_read_8 is
dependencies: no_reset;
for timepoints:
	 t_end = t+1;
freeze:
...
property memAccess_3_read_9 is
dependencies: no_reset;
for timepoints:
	 t_end = t+1;
freeze:
...
prove:
	 ...
	 at t+1: CUtoME_port_sig_addrIn = CUtoME_data_addrIn_at_t;
	 at t+1: CUtoME_port_sig_dataIn = CUtoME_data_dataIn_at_t;
	 at t+1: CUtoME_port_sig_mask = CUtoME_data_mask_at_t;
	 at t+1: CUtoME_port_sig_req = CUtoME_data_req_at_t;
