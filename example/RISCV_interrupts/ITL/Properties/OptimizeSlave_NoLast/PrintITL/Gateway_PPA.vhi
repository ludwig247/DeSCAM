...
-- DP SIGNALS --
macro IntReq_sig : boolean := IntReq end macro;
macro IntSig_sig : boolean := IntSig end macro;
macro fromMemoryPending_sig : boolean := fromMemoryPending end macro;
...
assume:
	 ...
	 at t: IntSig_sync;
	 at t: IntSig_sig;
	 at t: not((not((int_counter <= resize(-1,32))) and int_allowed));
	 at t: fromMemoryPending_sync;
	 at t: IntSig_sync;
prove:
	 at t+1: run_1;
