...
macro fromCore_MaxID_sig : unsigned := end macro; 
macro fromCore_MaxPriority_sig : unsigned := end macro; 
macro toCore_Claimed_sig : unsigned := end macro; 
macro toCore_Enabled_sig : unsigned := end macro; 
macro toCore_Priority_Int_1_sig : unsigned := end macro; 
macro toCore_Priority_Int_2_sig : unsigned := end macro; 
macro toCore_Threshold_sig : unsigned := end macro; 
macro toGatewayPending_1_sig : boolean := end macro; 
macro toGatewayPending_2_sig : boolean := end macro; 
