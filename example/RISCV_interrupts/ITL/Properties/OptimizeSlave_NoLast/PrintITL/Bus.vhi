...
assume: 
	 ...
	 at t: not(((resize(201326592,32) <= syscall_bus_Port_sig_addrIn) and not((resize(203423752,32) <= syscall_bus_Port_sig_addrIn))));
	 at t: syscall_bus_Port_sync;
prove:
	 at t_end: run_0;
...
assume: 
	 at t: run_4;
	 at t: syscall_bus_Port_sync;
	 at t: (resize(201326592,32) <= syscall_bus_Port_sig_addrIn);
	 at t: not((resize(203423752,32) <= syscall_bus_Port_sig_addrIn));
	 at t: syscall_bus_Port_sync;
prove:
	 at t_end: run_11;
