...
prove:
	at t_end: run_3;
	at t_end: mem_man_to_bus_sig_loadedData = response_data(ctrl_to_mem_man_sig_CR_reg_at_t,ctrl_to_mem_man_sig_DR_reg_at_t,ctrl_to_mem_man_sig_SR_reg_at_t,bus_to_mem_man_sig_addrIn_at_t,bus_to_mem_man_sig_dataIn_at_t,bus_to_mem_man_sig_mask_at_t,bus_to_mem_man_sig_req_at_t);
	at t_end: mem_man_to_ctrl_sig_addrIn = bus_to_mem_man_sig_addrIn_at_t;
	at t_end: mem_man_to_ctrl_sig_dataIn = bus_to_mem_man_sig_dataIn_at_t;
	at t_end: mem_man_to_ctrl_sig_mask = bus_to_mem_man_sig_mask_at_t;
	at t_end: mem_man_to_ctrl_sig_req = bus_to_mem_man_sig_req_at_t;
	at t_end: response_loadedData = response_data(ctrl_to_mem_man_sig_CR_reg_at_t,ctrl_to_mem_man_sig_DR_reg_at_t,ctrl_to_mem_man_sig_SR_reg_at_t,bus_to_mem_man_sig_addrIn_at_t,bus_to_mem_man_sig_dataIn_at_t,bus_to_mem_man_sig_mask_at_t,bus_to_mem_man_sig_req_at_t);
