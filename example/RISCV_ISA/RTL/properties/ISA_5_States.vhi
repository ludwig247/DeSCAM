...
-- STATES -- 
macro execute_4  : boolean := (section = store)   end macro;
macro execute_10 : boolean := (section = load1)   end macro;
macro execute_11 : boolean := (section = load2)   end macro;
macro fetch_15   : boolean := (section = fetch)   end macro;
macro fetch_16   : boolean := (section = execute) end macro;
