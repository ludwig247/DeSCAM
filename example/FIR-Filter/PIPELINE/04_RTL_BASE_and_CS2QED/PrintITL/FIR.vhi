...
property cycle_0 is
dependencies: no_reset, data_in_restr,liveness;
for timepoints:
	t_data_in_1 = t,
	t_data_in_1_wait = t_data_in_1+0..5 waits_for p1_data_in_sync,
	t_data_in_1_wait = t_data_in_1+0.. max_wait waits_for complete p1_data_in_sync, ------- ################# LOOK HERE -----------
...
for timepoints: 
	...
	-- relaxed instance
	t_data_in_1_i2 = t,
	t_data_in_1_wait_i2 = t_data_in_1_i2+0..2 waits_for p2_data_in_sync,
	t_C1_2_i2 = t_data_in_1_wait_i2+1..2 waits_for p2_data_in_sync,
	t_C2_3_i2 = t_C1_2_i2+1..2 waits_for p2_data_in_sync,
	t_C3_4_i2 = t_C2_3_i2+1..2 waits_for p2_data_in_sync,
	t_data_out_5_i2 = t_C3_4_i2+1..2 waits_for p2_data_in_sync,
	t_data_out_5_wait_i2 = t_data_out_5_i2+0..2 waits_for p2_data_in_sync,
	t_end_i2 = t_data_out_5_wait_i2+1..2 waits_for p2_data_in_sync;
freeze:	
...
assume:
	...
	at t: p1_data_in_sig /= p2_data_in_sig;
	--at t+1: p1_data_in_sig = p2_data_in_sig;
	--at t+2: p1_data_in_sig = p2_data_in_sig;
...
prove:	
	...
	at t_data_out_5_i2: p2_data_out_notify = true;
