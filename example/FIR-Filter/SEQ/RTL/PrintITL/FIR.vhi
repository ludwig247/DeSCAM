...
prove:
	 ...
	 at t: data_algorithm = resize(0,32);
...
freeze:
	...
	data_algorithm_at_t = data_algorithm@t,
...
prove:
	at t_end: C2_3;
	at t_end: acc = (acc_at_t + (coef_2_at_t * shiftreg_1_at_t)(31 downto 0))(31 downto 0);
	at t_end: coef(0) = coef_0_at_t;
	at t_end: coef(1) = coef_1_at_t;
	at t_end: coef(2) = coef_2_at_t;
	at t_end: data_algorithm = data_algorithm_at_t;
	at t_end: shiftreg(0) = data_algorithm_at_t;
...
prove:
	...
	at t_end: coef(1) = coef_1_at_t;
	at t_end: coef(2) = coef_2_at_t;
	at t_end: data_algorithm = data_in_sig_at_t;
	at t_end: shiftreg(0) = shiftreg_0_at_t;
	at t_end: shiftreg(1) = shiftreg_1_at_t;
	at t_end: shiftreg(2) = shiftreg_2_at_t;
	during[t+1, t_end]: data_in_notify = false;
...
prove:
	...
	at t+1: data_algorithm = data_algorithm_at_t;
