...
-- DP SIGNALS --
macro data_in_sig : signed := FIR.data_in end macro;
macro data_out_sig : signed := FIR.data_out end macro;
...
-- VISIBLE REGISTERS --
macro acc : signed := FIR.acc_signal end macro;
macro coef : int_3 := FIR.coef_signal end macro;
macro data_algorithm : signed := FIR.data_algorithm_signal end macro;
macro shiftreg : int_3 := FIR.shiftreg_signal end macro;
